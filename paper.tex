...
\subsection{Gauge}
Given hypergeometric $F(n,k)$, we define a gauge-transformed summand by
\[
G(n,k)=c(n,k)F(n,k), \qquad c\in\mathbb{Q}(n,k).
\]
We compare raw, closed-form, and recurrence-LHS gauges.
...
\href{https://github.com/JoseClaudioSJr/gauge-reachability-symbolic-search}{github.com/JoseClaudioSJr/gauge-reachability-symbolic-search}
